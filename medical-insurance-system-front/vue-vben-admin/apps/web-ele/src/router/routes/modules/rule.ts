...
const ruleLibrary: RouteRecordRaw = {
  ...
  children: [
    ...
    },
    {
      ...
      meta: { title: '超限定用药规则', icon: 'mdi:pill' , hideInMenu: true },
    },
    {
      path: 'over-standard-fee',
      ...
      meta: { title: '超标准收费规则', icon: 'mdi:cash-multiple', hideInMenu: true },
    },
    {
      path: 'duplicate-charge',
      ...
      component: () => import('#/views/rule/RuleDetail.vue'),
      props: { ruleType: '重复收费' },
      meta: { title: '重复收费规则', icon: 'mdi:repeat', hideInMenu: true },
    },
    {
      path: 'over-medical',
      ...
      meta: { title: '过度医疗规则', icon: 'mdi:stethoscope', hideInMenu: true },
    },
    {
      path: 'fake-fee',
      name: 'RuleFakeFee',
      ...
      meta: { title: '超频次收费规则', icon: 'mdi:alert-circle-outline', hideInMenu: true },
    },
  ],
};
